defmodule MomentumApiWeb.ProductController do
  use MomentumApiWeb, :controller

  alias MomentumApi.Catalog
  alias MomentumApi.Catalog.Product

  action_fallback MomentumApiWeb.FallbackController
